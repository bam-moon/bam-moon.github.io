!(function () {
  ...
  if ("userAgentData" in navigator)
    var f = /^Mac/i.test(window.navigator.userAgentData.platform);
  else f = /^Mac/i.test(window.navigator.platform);
  var w = {
      left: 37,
      up: 38,
      right: 39,
  ...
  function h() {
    if (!s && document.body) {
      ...
      if (
        ...
        (e = n),
        a.keyboardSupport && Y("keydown", D),
        top != self)
      )
        l = !0;
      else if (U && d > c && (n.offsetHeight <= c || r.offsetHeight <= c)) {
        var f,
          ...
          (o = function () {
            f ||
              (f = setTimeout(function () {
                i ||
                  ((w.style.height = "0"),
                  (w.style.height = u.scrollHeight + "px"),
                  (f = null));
              }, 500));
          }),
          setTimeout(o, 10),
  ...
  function b(e, t, o) {
    ...
    if (
      ...
      var d = function (n) {
        for (var r = Date.now(), i = 0, l = 0, c = 0; c < v.length; c++) {
          var s = v[c],
            f = r - s.start,
            w = f >= a.animationTime,
            m = w ? 1 : f / a.animationTime;
          a.pulseAlgorithm && (m = I(m));
  ...
  function D(t) {
    ...
    if (
      ...
      return !0;
    if (
      (N(o, "button") || (N(o, "input") && r.test(o.type))) &&
      t.keyCode === w.spacebar
    )
      return !0;
    ...
    var i = 0,
      c = 0,
      s = z(e);
    if (!s) return !l || !W || parent.keydown(t);
  ...
  function C(e, t, o) {
    for (var n = o ? M : E, r = e.length; r--; ) n[A(e[r])] = t;
    return t;
  }
  function H(e, t) {
    return (t ? M : E)[A(e)];
  ...
  function z(e) {
    ...
    do {
      ...
      if ((t.push(e), n === e.scrollHeight)) {
        var a = (O(u) && O(o)) || X(u);
        if ((l && L(u)) || (!l && a)) return C(t, V());
      } else if (L(e) && X(e)) return C(t, e);
  ...
  if ("userAgentData" in navigator) {
    var _ = !1,
      U = !1;
    for (let e = 0; e < window.navigator.userAgentData.brands.length; e++)
      if ("Safari" === window.navigator.userAgentData.brands[e].brand) {
        _ = !0;
        if (window.navigator.userAgentData.brands[e].version <= 9) U = !0;
      }
  } else
    U =
      (_ = /safari/i.test(window.navigator.userAgent)) &&
      (/Version\/8/i.test(window.navigator.userAgent) ||
        /Version\/9/i.test(window.navigator.userAgent));
  if ("userAgentData" in navigator) {
    var W = !1;
    for (let e = 0; e < window.navigator.userAgentData.brands.length; e++)
      if ("Chromium" === window.navigator.userAgentData.brands[e].brand) W = !0;
  } else W = /chrome/i.test(window.navigator.userAgent);
  if ("userAgentData" in navigator)
    var G = window.navigator.userAgentData.mobile;
  else G = /mobile/i.test(window.navigator.userAgent);
  var J = (W || _) && !G,
    Q = !1;
  try {
  ...
  ee && J && (Y(ee, y, Z), Y("mousedown", S), Y("load", h)),
    (te.destroy = function () {
      t && t.disconnect(),
        K(ee, y),
        K("mousedown", S),
