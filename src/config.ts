export default {
  ...
  TypeWriteList: [
    ...
    "If you think that the flowers will eventually fall when they bloom, then flowering will become a part of the tragedy.",
  ],
  // 网站创建时间
  ...
  WebSites: [
    ...
    {
      text: "Github",
      link: "https://github.com/wqangzuoshuai",
      icon: "WebSite_github",
    },
